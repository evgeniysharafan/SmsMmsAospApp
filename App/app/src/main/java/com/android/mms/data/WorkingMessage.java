...
import com.android.mms.compat.DataUsageStatUpdater;
...
public class WorkingMessage {
    ...
    private void markMmsMessageWithError(Uri mmsUri) {
        try {
            ...
            values.put(MmsSms.PendingMessages.ERROR_TYPE, MmsSms.ERR_TYPE_GENERIC_PERMANENT);
            long msgId = ContentUris.parseId(mmsUri);
            SqliteWrapper.update(mActivity, mContentResolver,
                    MmsSms.PendingMessages.CONTENT_URI,
                    values, MmsSms.PendingMessages.MSG_ID + "=" + msgId, null);
        } catch (MmsException e) {
