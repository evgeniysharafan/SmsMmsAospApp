...
package com.android.mms.compat;
...
import static com.android.mms.compat.TelephonyProperties.PROPERTY_ICC_OPERATOR_ISO_COUNTRY;
import static com.android.mms.compat.TelephonyProperties.PROPERTY_OPERATOR_IDP_STRING;
import static com.android.mms.compat.TelephonyProperties.PROPERTY_OPERATOR_ISO_COUNTRY;
...
public class PhoneNumberUtils {
    ...
    public static boolean compare(Context context, String a, String b) {
        boolean useStrict = false /*context.getResources().getBoolean(
     ...
     *
     * @param locale The locale of interest, usually {@link java.util.Locale#getDefault()}
...
//
//        numbers = SystemPropertiesProxy.get(MmsApp.getApplication(), ecclist);
//
//        if (TextUtils.isEmpty(numbers)) {
//            // then read-only ecclist property since old RIL only uses this
//            numbers = SystemPropertiesProxy.get(MmsApp.getApplication(), "ro.ril.ecclist");
//        }
//
//        if (!TextUtils.isEmpty(numbers)) {
...
//    }
    ...
    public static String cdmaCheckAndProcessPlusCode(String dialStr) {
        if (!TextUtils.isEmpty(dialStr)) {
            if (isReallyDialable(dialStr.charAt(0)) &&
                ...
                String currIso = SystemPropertiesProxy.get(MmsApp.getApplication(), PROPERTY_OPERATOR_ISO_COUNTRY, "");
                String defaultIso = SystemPropertiesProxy.get(MmsApp.getApplication(), PROPERTY_ICC_OPERATOR_ISO_COUNTRY, "");
    ...
    private static String getCurrentIdp(boolean useNanp) {
        ...
        String ps = SystemPropertiesProxy.get(MmsApp.getApplication(),
