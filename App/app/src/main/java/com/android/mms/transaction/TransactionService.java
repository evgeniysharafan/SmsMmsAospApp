...
import com.android.mms.compat.PhoneConstants;
...
public class TransactionService extends Service implements Observer {
    ...
    //TODO Evgeniy Phone.FEATURE_ENABLE_MMS changed to string
    public static final String FEATURE_ENABLE_MMS = "enableMMS";

    //TODO Evgeniy Phone.REASON_VOICE_CALL_ENDED changed to string
    ...
    public void onNewIntent(Intent intent, int serviceId) {
        ...
        if (mConnMgr == null || !MmsSystemEventReceiver.getMobileDataEnabled(this)
    ...
    private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (mConnMgr != null && MmsSystemEventReceiver.getMobileDataEnabled(context)) {
            ...
            if (mmsNetworkInfo == null) {
                ...
                if (REASON_VOICE_CALL_ENDED.equals(mmsNetworkInfo.getReason())) {
                    if (Log.isLoggable(LogTag.TRANSACTION, Log.VERBOSE)) {
                        Log.v(TAG, "   reason is " + REASON_VOICE_CALL_ENDED +
