...
public abstract class Transaction extends Observable {
    ...
    protected byte[] sendPdu(long token, byte[] pdu,
        ...
        ensureRouteToHost(mContext, mmscUrl, mTransactionSettings.getProxyAddress());
    ...
    protected byte[] getPdu(String url) throws IOException {
        ensureRouteToHost(mContext, url, mTransactionSettings.getProxyAddress());
        return HttpUtils.httpConnection(
     ...
     */
    //TODO Evgeniy new ensureRouteToHost
...
//    }
     ...
     */
    private void ensureRouteToHost(Context context, String url, String proxy) throws IOException {
        ConnectivityManager connMgr =
        ...
        if (proxy != null && proxy.trim().length() != 0) {
            ...
            try {
                ...
                Log.e("Transaction", "Cannot establishh route to proxy " + inetAddr, e);
            }
        } else {
            Uri uri = Uri.parse(url);
            try {
            ...
            try {
                ...
                Log.e("Transaction", "Cannot establishh route to proxy " + inetAddr + " for " + url, e);
            }
        }
    }
